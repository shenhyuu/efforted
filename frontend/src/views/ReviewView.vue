...
<template>
  <main class="single-page"><section class="form-card reflection-card">
    <div class="page-heading"><div><span class="eyebrow">主动回看</span><h1>只整理已经发生的事。</h1>
    <p class="lead">这份回看只在你点击后生成，只复述过去七天留在织痕里的事实。</p></div><span class="page-number" aria-hidden="true">07</span></div>
    <div v-if="!lines.length && !settings.values.weekly_report_opt_out" class="reflection-preview" aria-hidden="true">
